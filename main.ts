...
function walk10Miles () {
    ...
    story.showPlayerChoices("Drink the iced tea", "Make a snow man")
    if (story.checkLastAnswer("Drink the iced tea")) {
        drinkIcedTeaOnMountain()
    } else {
        makeASnowMan()
    }
}
function makeASnowMan () {
    scene.setBackgroundImage(img`
        ...
        9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
        `)
    game.showLongText("Your snowman becomes your best friend", DialogLayout.Bottom)
}
function drinkIcedTeaOnMountain () {
